        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="active">
                        <a href="staff_homepage.php"><span class="fa fa-desktop"></span> <span class="xn-text">Dashboard</span></a>                        
                    </li>    
                    <!--HIEP-class="xn-openable" de co dau +-->
                    <li>
                        <a href="#"><span class="fa fa-files-o"></span> <span class="xn-text">Manage Customers</span></a>
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <?php // echo var_dump($latestCustomer) ?>
                    <?php //  echo var_dump($testCustomer) ?>
                </div>
