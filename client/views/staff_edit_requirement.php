        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="active">
                        <a href="../../../CustomerController/viewCustomers"><span class="fa fa-files-o"></span> <span class="xn-text">Manage Customers</span></a>
                    </li>
                </ul>
                <!-- END X-NAVIGATION -->
            </div>
                    ...
                    <div class ="container">
                        <div class="row">
                            <div class="col-md-8 col-lg-8"> 
                                <?php
                                $attForms = array('class' => 'form-horizontal');
                                $hiddenDocId = array();
                                $i = 0;
                                foreach ($documents as $document) {
                                    $hiddenDocId['documentId'.$i] = $document->documentId;
                                    $i++;
                                }
////                              
//                                echo "<pre>";
...
//                                echo "</pre>";
                                ...
                                <?php echo form_open(base_url().'index.php/customercontroller/editCustomer/' . $requirement->requirementId . '/' . $customer->customerId, $attForms, $hiddenDocId); ?>
                                <div class="form-group">
                                    <label for="inputFirstName" class="col-sm-2 control-label">First Name</label>
                                    <div class="col-sm-10">
                                        <input name="firstName" value="<?php echo $customer->firstName ?>" type="text" class="form-control" id="inputFirstName" placeholder="First Name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="lastName" value="<?php echo $customer->lastName ?>" type="text" class="form-control" id="inputLastName" placeholder="Last Name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="dob" value="<?php echo $customer->birthDate ?>" type="text" class="form-control" id="dob" placeholder="Date Of Birth">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name = "country"
                                            ...
                                            <option selected="selected" value="<?php echo $customer->country ?>" ><?php echo $customer->country ?></option>
                                            <option value="<?php echo $customer->country == 'vietnam' ? 'australia' : 'vietnam' ?>" ><?php echo $customer->country == 'vietnam' ? 'australia' : 'vietnam' ?></option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="streetName" value="<?php echo $customer->streetName ?>" type="text" class="form-control" id="streetName" placeholder="Street Name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="suburb" value="<?php echo $customer->suburb ?>" type="text" class="form-control" id="suburb" placeholder="Suburb">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="city" value="<?php echo $customer->city ?>" type="text" class="form-control" id="city" placeholder="City">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="state" value="<?php echo $customer->state ?>" type="text" class="form-control" id="state" placeholder="State">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="postCode" value="<?php echo $customer->postCode ?>" type="text" class="form-control" id="postCode" placeholder="Post Code">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="phoneNumber" value="<?php echo $customer->phoneNumber ?>" type="text" class="form-control" id="phoneNo" placeholder="Phone No">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="email0" value="<?php echo $customer->email0 ?>" type="text" class="form-control" id="email0" placeholder="1st Email">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="email1" value="<?php echo $customer->email1 ?>" type="text" class="form-control" id="email1" placeholder="2nd Email">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="email2" value="<?php echo $customer->email2 ?>" type="text" class="form-control" id="email2" placeholder="3rd Email">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="facebookLink" value="<?php echo $customer->facebookLink ?>" type="text" class="form-control" id="facebook" placeholder="Facebook Link">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <!--HIEP-EXP: khong nen dung teriary trong tag, hay tao ra bien va dung if else cho no -->
                                            <?php
                                            for ($i = 0; $i < count($documents); $i++) {
                                                $typeOfDoc = '';
                                                if ($documents[$i]->type == 'scan') {
                                                    $typeOfDoc = 'original';
                                                } else {
                                                    $typeOfDoc = 'scan';
                                                }
                                                echo '<div class="row documentContain">';

                                                echo '<input name = "documents' . $i . '" value="' . $documents[$i]->name . '" type="text" class="form-control" id="documents"' . $i . 'placeholder="Document">';
                                                echo '<select name = "typeOfScan' . $i . '" class="form-control" id="selectTypeOfDoc">';
                                                echo '<option value="' . $documents[$i]->type . '" >' . $documents[$i]->type . '</option>';
                                                echo '<option value="' . $typeOfDoc . '" >' . $typeOfDoc . '</option>';
                                                echo '</select>';
//                                                echo 'input type="hidden" name="documentId'.$i.'" value="'.$documents[$i].'"';
                                                echo "</div>";
                                            }
                                            ?>
                                            <button id="btnAddDocument_edit" type="button" class="btn btn-primary">+ Add More</button>
                                            <button id="btnDeleteDocument_edit" type="button" class="btn btn-primary">- Delete</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name = "requirementStatus"
                                            ...
                                            <option value="completed" <?php echo set_select('requirementStatus', 'completed', (!empty($requirement->status) && $requirement->status == "completed" ? TRUE : FALSE)); ?> >Completed</option>
                                            <option value="in process" <?php echo set_select('requirementStatus', 'in process', (!empty($requirement->status) && $requirement->status == "in process" ? TRUE : FALSE)); ?> >Processing</option>
                                            <option value="potential" <?php echo set_select('requirementStatus', 'potential', (!empty($requirement->status) && $requirement->status == "potential" ? TRUE : FALSE)); ?> >Potential</option>
                                            <option value="cancel" <?php echo set_select('requirementStatus', 'cancel', (!empty($requirement->status) && $requirement->status == "cancel" ? TRUE : FALSE)); ?> >Cancel</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name = "staffTaken"
                                            ...
                                            <!--HIEP-EXP: do du lieu len thi can so sanh cai gi -> doc api-->
                                            <?php
                                            if (isset($staffs)) {
                                                foreach ($staffs as $staff) {
                                                    echo "<option value='" . $staff->staffId . "' " . set_select('staffTaken', $staff->staffId, $requirement->staffTakenId == $staff->staffId ? TRUE : FALSE) . ">"
                                    ...
                                    <div class="col-sm-10">
                                        <select name = "staffReturn"
                                                class="form-control" id="staffReturn">
                                                    ...
                                                    if (isset($staffs)) {
                                                        foreach ($staffs as $staff) {
                                                            echo "<option value='" . $staff->staffId . "'" . set_select('staffReturn', $staff->staffId, $requirement->staffReturnId == $staff->staffId ? TRUE : FALSE) . ">"
                                                            . $staff->firstName . " " . $staff->lastName . "-" . $staff->staffId . "</option>";
                                                        }
                                                    }
                                                    ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="returnDate" value="<?php echo $requirement->returnDate ?>" type="text" class="form-control" id="returnDate" placeholder="Return Date">
                                    </div>
                                </div>
                                <div class="form-group">
